...
static void activate(GtkApplication *app, gpointer user_data) {
    ...
    gtk_css_provider_load_from_data(provider,
        ...
        "#solve-button { background: transparent; color: #D4AF37; border: 2px solid #D4AF37; border-radius: 25px; padding: 15px 50px; font-size: 20px; font-weight: bold; min-width: 50px; max-width: 50px; }"
        "#solve-button:hover { background-color: rgba(212, 175, 55, 0.1); }"
        "#input-label { color: #D4AF37; font-size: 18px; font-weight: bold; }"
        "#size-dropdown { background: rgba(255, 255, 255, 0.1); color: white; border: 2px solid #D4AF37; border-radius: 5px; padding: 5px; }"
        "#method-dropdown { background: rgba(255, 255, 255, 0.1); color: white; border: 2px solid #D4AF37; border-radius: 5px; padding: 5px; }"
        "#generate-button { background: transparent; color: #D4AF37; border: 2px solid #D4AF37; border-radius: 25px; padding: 10px 20px; font-size: 16px; font-weight: bold; }"
        "#generate-button:hover { background-color: rgba(212, 175, 55, 0.1); }"
        "#chess-grid { background: rgba(255, 255, 255, 0.1); padding: 10px; }"
        "#grid-cell { background: #E6E6FA; min-width: 50px; min-height: 50px; }"
        "#queen-cell { background: #000000; min-width: 50px; min-height: 50px; }"
        "#back-button { background: transparent; color: #FF0000; border: 2px solid #FF0000; border-radius: 25px; padding: 10px 20px; font-size: 16px; font-weight: bold; }"
        "#back-button:hover { background-color: rgba(255, 0, 0, 0.1); }"
        "#close-button { background: transparent; color: #FF0000; border: 2px solid #FF0000; border-radius: 25px; padding: 10px 20px; font-size: 16px; font-weight: bold; }"
        "#close-button:hover { background-color: rgba(255, 0, 0, 0.1); }"
        "#about-button { background: transparent; color: #D4AF37; border: 2px solid #D4AF37; border-radius: 25px; padding: 10px 20px; font-size: 16px; font-weight: bold; }"
        "#about-button:hover { background-color: rgba(212, 175, 55, 0.1); }"
        "#nav-button { background: transparent; color: #D4AF37; border: 2px solid #D4AF37; border-radius: 25px; padding: 10px 20px; font-size: 16px; font-weight: bold; }"
        "#nav-button:hover { background-color: rgba(212, 175, 55, 0.1); }"
        "#operation-label { color: #D4AF37; font-size: 16px; font-weight: bold; }"
        "#solution-count-label { color: #D4AF37; font-size: 16px; font-weight: bold; }"
        ".developer-card { "
